...
class NDM():
    ...
    def run_NDM(self):
        ...
        return x_t[CORT_IDX]/np.max(x_t,axis=0)
    ...
    def optimise_seed_region(self, target_data):
        ...
        for i,r in enumerate(regions):
            ...
            pearsonr[i] = np.corrcoef(target_data, prediction)[0,1]
        
        optimal_params = {}
        optimal_params["seed"] = regions[np.nanargmin(SSE)]
        res = pd.DataFrame({"seed":regions, "SSE":SSE, "r":pearsonr})
